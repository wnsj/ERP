...
<body>
	...
	<div class="container-fluid clear-mp" id="Odiv">
		<div class="row clear-mp">
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 my-aside clear-mp"
				id="Adiv">
				<div class="aside-logo">
					<h2 class="clear-mp">ERP系统</h2>
				</div>
				<ul id="aside-menu">
					<li><i class="fa fa-university" aria-hidden="true"></i>人员及权限<i
						class="fa fa-sort-desc item-down" aria-hidden="true"></i></li>
					<!-- 二级菜单 -->
					<ul class="second-menu">
						<c:if test="${user.status==1}">
							<li class="li-active"><i class="fa fa-circle"
								aria-hidden="true"></i>人员管理</li>
			...
			<div
				class="col-xs-10 col-sm-10 col-md-10 col-lg-10 my-content clear-mp"
				id="Cdiv">
				<nav class="navbar navbar-default my-navbar">
					<div class="container-fluid">
						<div class="navbar-header">
							<a class="navbar-brand my-navbar-brand" href="#"> <!-- <img alt="Brand" src="..."> -->
								<i class="fa fa-home fa-2x"></i>
							</a>
						</div>
						<div class="collapse navbar-collapse">
							<ul class="nav navbar-nav navbar-right my-signed">
								<li><a href="#"><i class="fa fa-user fa-fw"></i>${user.account_name}</a>
								</li>
								<li><a href="#">个人中心</a></li>
				...
				<div class="embed-responsive embed-responsive-16by9 my-main">
					<iframe class="embed-responsive-item" id="common-iframe"
						src="<%=path%>/search/ryList"></iframe>
				</div>
			</div>
		</div>
	</div>
