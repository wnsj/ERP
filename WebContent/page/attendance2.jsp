	...
	<div id="myTabContent" class="tab-content">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-9 mtr_a">
						<span>部门：</span> <span class="com-sel"><select class="">
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>职位：</span> <span class="com-sel"><select class="">
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>姓名：</span> <span><input type="text" value=""
							class="form-control" /></span> <span>工号：</span> <span><input
							type="text" value="" class="form-control" /></span> <span
							class="search pull-right"><button class="btn btn-primary">导出</button></span>
						<span class="search pull-right"><button
								class="btn btn-warning">查询</button></span>
					</div>

					<div class="col-lg-11 mtr_a">
						<span>时间：</span> <span><input type="date" value=""
							id="time_start" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span> <span><input
							type="date" value="" id="time_over" /></span>
					</div>

					<div class="col-lg-11 mtr_a">
						<span>注：</span> <span style="color: #FF0000; margin-right: 10px;">旷工</span>
						<span style="color: #CD853F; margin-right: 10px;">迟到/早退</span> <span
							style="color: #000000; margin-right: 10px;">正常</span> <span
							style="color: #9370DB; margin-right: 10px;">休息</span> <span
							style="color: #006400; margin-right: 10px;">请假</span> <span
							style="color: #00679D; margin-right: 10px;">倒休</span> <span
							style="color: #FF7F50; margin-right: 10px;">打卡异常</span> <span
							style="color: #87CEFA; margin-right: 10px;">加班</span> <span
							style="color: #D2B48C; margin-right: 10px;">漏打卡</span>
					</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-8 mtr_a">
						<span>部门：</span> <span class="com-sel"><select>
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>时间：</span> <span><input type="date" value=""
							class="form-control" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span> <span><input
							type="date" value="" class="form-control" /></span> <span
							class="search"><button class="btn btn-primary">导出</button></span>
					...
					<div class="col-lg-11 mtr_a">
						<span>注：</span> <span style="color: #FF0000; margin-right: 10px;">旷工</span>
						<span style="color: #CD853F; margin-right: 10px;">迟到</span> <span
							style="color: #000000; margin-right: 10px;">正常</span> <span
							style="color: #9370DB; margin-right: 10px;">休息</span> <span
							style="color: #006400; margin-right: 10px;">请假</span> <span
							style="color: #00679D; margin-right: 10px;">倒休</span> <span
		...
		<div class="tab-pane fade" id="grcqmx">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-8 mtr_a">
						<span>时间：</span> <span><input type="date" value="" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span>
						<span><input type="date" value="" /></span> <span class="search"><button
								class="btn btn-primary">导出</button></span> <span class="search"><button
								class="btn btn-warning">查询</button></span>
				...
				<div class="table-responsive">
					<div class="col-lg-10 mtr_a">
						<span>部门：</span> <span class="com-sel"><select>
								...
								<option>2</option>
								<option>3</option>
						</select></span> <span>职位：</span> <span class="com-sel"><select>
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>姓名：</span> <span><input type="text" value="" id="" /></span>
						<span>工号：</span> <span><input type="text" value="" id="" /></span>
		...
		<div class="tab-pane fade" id="kqbb">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-10 mtr_a">
						<span><input type="radio" name="xm" /></span> <span>部门：</span> <span
							class="com-sel"><select>
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>职位：</span> <span class="com-sel"><select>
					...
					<div class="col-lg-11 mtr_a">
						<span><input type="radio" name="xm" /></span> <span>项目：</span> <span
							class="com-sel"><select>
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>时间：</span> <span><input type="date" value="" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span>
						<span><input type="date" value="" /></span>
					</div>
		...
		<div class="tab-pane fade" id="kqtjbb">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					...
					<div class="col-lg-11 mtr_a">
						<span>姓名：</span> <span><input type="text" value="" id="" /></span>
						<span>工号：</span> <span><input type="text" value="" id="" /></span>

					</div>

					<div class="col-lg-11 mtr_a">
						<span>注：</span> <span style="color: #000000; margin-right: 10px;">正常</span>
		...
		<div class="tab-pane fade" id="rypbjh">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
						...
						<div class="treebox">
							<div class="tree">
								<ul>
									...
									<li><div class="close_menu top_menu">
											<span><img src="img/top_menu.jpg" width="24"
												height="24" /></span><a title="九博健康管理有限公司">九博健康管理有限公司</a>
										</div>
										<ul class="bm_sun">
											<li>
												<div class="close_menu sun_menu">
													<span><img src="img/son_menu.jpg" width="24"
														height="24" /></span><a title="人力综合办">人力综合办</a>
												</div>
												<ul class="sex">
													<li>
														<div class="close_menu unm">
															<span><input type="hidden" value="0" class="cc" /><img
																src="img/man.jpg" width="24" height="24" /></span><a
																title="李珊珊">李珊珊</a>
														</div>
													</li>
													<li>
														<div class="close_menu unm">
															<span><input type="hidden" value="1" class="cc" /><img
																src="img/man.jpg" width="24" height="24" /></span><a
																title="王建军">王建军</a>
														</div>
													</li>
				...
				<div class="table-responsive col-xs-9 col-sm-9 col-md-9 col-lg-9"
					style="position: relative; padding-bottom: 30px;">
					<div class="col-lg-4 mtr_a clearfix">
						<span>查找：</span> <span><input type="text" name=""
							class="form-control" placeholder="输入姓名,快速查找..."
							style="width: 200px;" /></span> <span><button
								class="btn btn-infor">查询</button></span>
					</div>
					<div class="col-lg-8 mtr_a big_font_size">
						<span><a href="#weekday" data-toggle="tab"
							aria-expanded="true">月</a></span> | <span>周</span> | <span>刷新</span> | <span>&lt;</span>
						000 <span>&gt;</span><font class="pull-right"> 员工:<span
							id="uname">未选择员工</span></font>
					...
					<div id="main"
						style="width: 1000px; height: 1000px; margin-bottom: 30px; top: 50px; position: static;"></div>
    ...
    series: [
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-8 mtr_a">
						<span>时间：</span> <span><input type="date" value="" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span>
						<span><input type="date" value="" /></span> <span class="search"><button
								class="btn btn-warning">查询</button></span> <span class="search"><button
								class="btn btn-danger">删除</button></span>
		...
		<div class="tab-pane fade" id="pbjhdr">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="table-responsive">
					<div class="col-lg-8 mtr_a">
						<span>排班计划：</span> <span><input class="" type="file"
							value="" id="" /></span>
...
-->
		...
		<div class="tab-pane fade" id="jqzlgl">
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4"
				...
				<button class="btn-primary btn pull-left" data-toggle='modal'
				...
				<div class="modal-content">
					...
					<div class="modal-body clearfix">
						<div class="col-md-10 col-md-offset-1">
							<p>
								假期种类：<input type="text" class="form-control"
									placeholder="输入假期类型" style="margin-top: 20px;" />
							</p>
						</div>
					</div>
		...
		<div class="tab-pane fade" id="cqgzgl">
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"
				style="position: relative;">
				<div
					class="table-responsive col-xs-10 col-sm-10 col-md-10 col-lg-10">
					<!--					<div class="col-lg-8 mtr_a">
						<span>考勤规则管理：</span>
					</div>
-->
		...
		<div class="tab-pane fade" id="pbgzgl">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
				style="position: relative;">
				<div
					class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<!--					<div class="col-lg-8 mtr_a">
						<span>排班规则管理：</span>
					</div>
-->
			...
			<button class="btn-primary btn pull-left" data-toggle='modal'
				data-target='#mypbgzgl'>新增</button>
		</div>
		...
		<div class="tab-pane fade" id="gwlxgl">
			<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7"
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><a data-toggle='modal'
									data-target='#mymodale' style="cursor: pointer;">修改</a></td>
								<td class="text-center"><a class="delet"
				...
				<button class="btn-primary btn" data-toggle='modal'
					data-target='#mygwlxgl'>新增</button>
			</div>
		</div>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
				...
				<div class="table-responsive col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="col-lg-12 mtr_a clearfix">
						<span>查找：</span> <span><input type="text" name=""
							placeholder="输入姓名,快速查找..." style="width: 200px;" /></span>
					</div>
						...
						<div class="treebox">
							<div class="tree">
								<ul>
									...
									<li><div class="close_menu">
											<span></span><a title="一级菜单">九博健康管理有限公司</a>
										</div>
										<ul>
											<li>
												<div class="close_menu">
													<span></span><a title="一级菜单">人力综合办</a>
												</div>
												<ul>
													<li>
														<div class="close_menu bc">
															<a title="二级菜单">李珊珊</a>
														</div>
													</li>
													<li>
				...
				<div class="table-responsive col-xs-9 col-sm-9 col-md-9 col-lg-9"
					...
					<div class="col-lg-12 mtr_a">
						<span>类型：</span> <span class="com-sel"><select
							class="com-opt">
								<option>1</option>
								<option>2</option>
								<option>3</option>
						</select></span> <span>时间：</span> <span><input class="com-opc" type="text"
							value="" id="time_startqjgl" /></span> <span>&nbsp;&nbsp;&nbsp;至：</span>
						<span><input class="com-opc" type="text" value=""
							id="time_overqjgl" /></span> <span class="search"><button
								class="btn btn-primary">导出</button></span> <span class="search"><button>全部</button></span>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body clearfix">
						<div class="col-md-10 col-md-offset-1">
							<p>
								假期种类：<input type="text" id="new_jqlx" placeholder="输入假期类型" />
							</p>
						</div>
					</div>
					<div class="modal-footer">
