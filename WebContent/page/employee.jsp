...
<link rel="stylesheet"
	href="<%=path%>/js/bootstrap-datetimepicker.min.js">
...
<body>
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
					<div class="input-group">
						<input type="text" class="form-control"
							placeholder="Search for..." name="searchContent"> <span
			...
			<div class="row">
				<div class="col-md-12 col-lg-12 user-btn-group">
					...
					<button type="button" class="btn btn-warning" data-toggle="modal"
						data-target="#myModalQuery">高级查询</button>
					<button type="button" class="btn btn-warning" data-toggle="modal"
						data-target="#myModalFamily">家庭成员</button>
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target="#myModalJoin">员工入职</button>
					<button type="button" class="btn btn-primary" id="exportButton"
						name="exportButton">导出</button>
				</div>
			</div>
		</form>
		<div class="row">
	...
	<div class="row">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="col-md-1 col-lg-1 clear-mp"
							...
							<div class="row add-mt">
								<div class="form-inline col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="date" class="form-control" id="firstTime"
												name="startDate">
								...
								<div class="form-inline col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="date" class="form-control" id="secondTime"
												name="endDate">
											<div class="input-group-addon">
												<span class="glyphicon glyphicon-calendar"></span>
											</div>
							...
							<div class="row add-mt">
								<div
									...
									<div class="col-md-3 col-lg-3 clear-mp"
										style="line-height: 34px;">
										<label>查看生日在：</label>
									</div>
									...
									<div class="col-md-2 col-lg-2 clear-mp"
		...
		<!-- 家庭成员 -->
		<div class="modal fade" id="myModalFamily" tabindex="-1" role="dialog"
		...
		<!--员工入职弹出-->
		<div class="modal fade" id="myModalJoin" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel" aria-hidden="true">
							...
							<div class="tab-content"
								...
								<div class="tab-pane fade in active martop" id="basic">
									...
									<div class="form-group clearfix">
										<label for="cyname"
											class="col-md-2 control-label text-right nopad">成员姓名：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="uName"
												placeholder="" name="uName" value="穆文亮">
										</div>
										<div class="col-md-3 text-danger linhet">已离职</div>
									</div>
									<div class="form-group clearfix">
										<label for="sex"
											class="col-md-2 control-label text-right nopad">性别：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="uSex"
												placeholder="" name="uSex" value="男">
										</div>
									</div>
									<div class="form-group clearfix">
										<label class="col-md-2 control-label text-right nopad">出生年月：</label>
										<div class="col-md-5 input-group date form_date">
											<input type="date" class="form-control" id="uBirth" value=""
												name="uBirth"> <span class="input-group-addon"><span
												class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									<div class="form-group clearfix">
										<label for="gh"
											class="col-md-2 control-label text-right nopad">工号：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="uJobNum"
												placeholder="" name="uJobNum">
										</div>
									</div>
									<div class="form-group clearfix">
										<label for="erpzh"
											class="col-md-2 control-label text-right nopad">ERP账号：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="uAccount"
												placeholder="" name="uAccount">
										</div>
									</div>
									<div class="form-group clearfix">
										<label class="col-md-2 control-label text-right nopad">部门：</label>
										<div class="col-md-5">
											<select class="form-control" id="uDepartment_id"
												name="uDepartment_id">
									...
									<div class="form-group clearfix">
										...
										<div class="col-md-5 input-group date form_date">
											<input type="date" class="form-control" value=""
												id="uEntryDte" name="uEntryDte"> <span
									...
									<div class="form-group clearfix">
										...
										<div class="col-md-5 input-group date form_date">
											<input type="date" class="form-control" value=""
												id="uPositiveDate" name="uPositiveDate"> <span
												class="input-group-addon"><span
												class="glyphicon glyphicon-calendar"></span></span>
										</div>
									...
									<div class="form-group clearfix">
										...
										<div class="col-md-5 input-group date form_date">
											<input type="date" class="form-control" value=""
												id="uResignDate" name="uResignDate"> <span
												class="input-group-addon"><span
												class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									<div class="form-group clearfix">
										...
										<div class="col-md-5">
											<select class="form-control" id="uResignType"
												name="uResignType">
									...
									<div class="form-group clearfix">
										...
										<div class="col-md-5">
											<textarea class="form-control" rows="3" id="uRemark"
												name="uRemark"></textarea>
										</div>
									</div>
								...
								<div class="tab-pane fade" id="detailed">
									...
									<div class="martop1 clearfix">
										...
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uHomeTown" name="uHomeTown">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											<label class="col-md-4 control-label text-right nopad">民族：</label>
											<div class="col-md-8">
												<select class="form-control" id="uNationality"
													name="uNationality">
										...
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uAccountProp" name="uAccountProp">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
										...
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uHomeAddress" name="uHomeAddress">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uCurrentAddress" name="uCurrentAddress">
											</div>
										</div>
									</div>
									<div class="martop1 clearfix">
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uSchools" name="uSchools">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											<label class="col-md-4 control-label text-right nopad">最高学历：</label>
											<div class="col-md-8">
												<select class="form-control" id="uEducation"
													name="uEducation">
										...
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uProfession" name="uProfession">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8 input-group date form_date">
												<input type="date" class="form-control" value=""
													id="uGraduation" name="uGraduation"> <span
													class="input-group-addon"><span
													class="glyphicon glyphicon-calendar"></span></span>
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<div class="checkbox">
													<label> <input type="checkbox" id="uAtSchool"
														name="uAtSchool">是
													</label>
												</div>
											</div>
									...
									<div class="martop1 clearfix">
										...
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uEmergencyContact" name="uEmergencyContact">
											</div>
										</div>
									</div>
									...
									<div class="martop1 clearfix">
										<div class="form-group col-md-6 clearfix">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" placeholder=""
													id="uDrivingExpe" name="uDrivingExpe">
											</div>
										</div>
										<div class="form-group col-md-6 clearfix">
											<label class="col-md-4 control-label text-right nopad">驾照类型：</label>
											<div class="col-md-8">
												<select class="form-control" id="uLicenseType"
													name="uLicenseType">
								...
								<form action="">
									<div class="form-group clearfix">
										<label for="cyname"
											class="col-md-2 control-label text-right nopad">成员姓名：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="cyname"
												v-model="updateName">
										</div>
										<template>
										<div class="col-md-3 text-danger linhet"
											v-if="updateState == 2">已离职</div>
										</template>
									</div>
									<div class="form-group clearfix">
										<label for="sex"
									...
									<div class="form-group clearfix">
										<label for="gh"
											class="col-md-2 control-label text-right nopad">工号：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="gh"
												v-model="updateJobNum" disabled>
										</div>
									</div>
									<div class="form-group clearfix">
										<label for="erpzh"
											class="col-md-2 control-label text-right nopad">ERP账号：</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="erpzh"
												v-model="updateAccount" disabled>
										</div>
									</div>
									<div class="form-group clearfix">
										<label class="col-md-2 control-label text-right nopad">部门：</label>
										<div class="col-md-5">
											<select class="form-control" v-model="updateDepartment"
												disabled>
									...
									<div class="form-group clearfix">
										<label class="col-md-2 control-label text-right nopad">职位：</label>
										<div class="col-md-5">
											<select class="form-control" v-model="updatePosition"
												disabled>
												<option v-bind:value="item.position_Name"
													v-for="(item, index) in positionList">{{item.position_Name}}</option>
											</select>
										</div>
									...
									<div class="form-group clearfix">
										...
										<div class="col-md-5 input-group date form_date">
											<input type="date" class="form-control"
												v-model="updatePositiveDate"> <span
												class="input-group-addon"><span
												class="glyphicon glyphicon-calendar"></span></span>
										</div>
										<template>
										<div class="col-md-3 text-primary linhet"
											v-if="updatePositiveDate == ''">非转正员工</div>
										</template>
									</div>
									<div class="form-group clearfix">
										<label class="col-md-2 control-label text-right nopad">离职日期：</label>
							...
							<div class="tab-pane fade" id="updatedetailed">
										...
										<div class="col-md-8">
											<select class="form-control" v-model="updateNationality">
												<option v-for="item in nationList"
													v-bind:value="item.nation">{{item.nation}}</option>
											</select>
										</div>
									</div>
									<div class="form-group col-md-6 clearfix">
								...
								<div class="martop1 clearfix">
									...
									<div class="form-group col-md-6 clearfix">
										...
										<div class="col-md-8">
											<input type="text" class="form-control"
												v-model="updateEmergencyContact">
										</div>
									</div>
									<div class="form-group col-md-6 clearfix">
										<label class="col-md-4 control-label text-right nopad">紧急联系方式：</label>
							...
							<div class="tab-pane fade" id="updatefamily">
								...
								<div class="col-md-12 clearfix nopad addbord martop">
									<table class="table table-bordered table-responsive">
										...
										<tbody>
											<tr v-for="(item,index) in FamilyNumList"
												v-on:dblclick="updateEmployeeFamily(item.account_ID)">
									...
									<div class="col-md-8 col-md-offset-2">
										...
										<div class="col-md-2 col-md-offset-8">
											<button type="button" class="btn btn-warning" v-on:click="">确认</button>
										</div>
										<div class="col-md-2">
					...
					<div class="modal-footer">
						...
						<div class="col-md-12">
							...
							<button type="button" class="btn btn-info"
								v-on:click="updateEmployeeInfo">确认</button>
							<button type="button" data-dismiss="modal" class="btn btn-info">返回</button>
						</div>
					</div>
				</div>
