...
public class DepartmentBean implements Serializable{
	...
	public String toString() {
		return "DepartmentBean [ID=" + ID + ", Name=" + Name + ", ParentID=" + ParentID + ", OrderNum=" + OrderNum
				+ ", children=" + children + ", employeeList=" + employeeList + ", positionDataList=" + positionDataList
				+ ", jinSheng=" + jinSheng + ", jiangZhi=" + jiangZhi + ", change=" + change + ", diaoChu=" + diaoChu
				+ ", diaoRu=" + diaoRu + ", count=" + count + ", sumCount=" + sumCount + ", resignation=" + resignation
				+ ", dismiss=" + dismiss + ", unKnow=" + unKnow + ", total=" + total + ", begMonCount=" + begMonCount
